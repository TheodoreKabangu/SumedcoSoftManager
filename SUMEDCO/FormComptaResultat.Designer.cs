namespace SUMEDCO
{
    partial class FormComptaResultat
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dgvResultat.DefaultCellStyle = dataGridViewCellStyle5;
            ...
            "TA_Ventes de marchandises_21",
            "RA_Achats de marchandises_22",
            "BR_Variation de stocks de marchandises_6",
            "XA_MARGE  COMMERCIALE  (Somme TA à RB)",
            "TB_Ventes de produits fabriqués\t_21",
            "TC_Travaux, services vendus_21",
            "TD_Produits accessoires_21",
            "XB_CHIFFRE D\'AFFAIRES (TA + TB + TC + TD)",
            "TE_Production stockée (ou déstockage)_6",
            "TF_Production immobilisée_21",
            "TG_Subventions d’exploitation_21",
            "TH_Autres produits_21",
            "TI_Transferts de charges d\'exploitation_12",
            "RC_Achats de matières premières et fournitures liées_22",
            "RD_Variation de stocks de matières premières et fournitures liées_6",
            "RE_Autres achats_22",
            "RF_Variation de stocks d’autres approvisionnements_6",
            "RG_Transports_23",
            "RH_Services extérieurs_24",
            "RI_Impôts et taxes_25",
            "RJ_Autres charges_26",
            "XC_VALEUR AJOUTEE (XB +RA+RB) + (somme TE à RJ)",
            "RK_Charges de personnel_27",
            "XD_EXCEDENT BRUT D\'EXPLOITATION (XC+RK)",
            "TJ_Reprises d’amortissements, provisions et dépréciations_28",
            "RL_Dotations aux amortissements, aux provisions et dépréciations_3C et 28",
            "XE_RESULTAT D\'EXPLOITATION (XD+TJ+ RL)",
            "TK_Revenus financiers et assimilés_29",
            "TL_Reprises de provisions  et dépréciations financières_28",
            "TM_Transferts de charges financières_12",
            "RM_Frais financiers et charges assimilées_29",
            "RN_Dotations aux provisions et aux dépréciations financières_3C et 28",
            "XF_RESULTAT  FINANCIER  (somme TK à RN)",
            "XG_RESULTAT  DES ACTIVITES ORDINAIRES (XE+XF)",
            "TN_Produits des cessions d\'immobilisations_3D",
            "TO_Autres Produits HAO_30",
            "RO_Valeurs comptables des cessions d\'immobilisations_3D",
            "RP_Autres Charges HAO_30",
            "XH_RESULTAT HORS ACTIVITES ORDINAIRES (somme TN à RP)",
            "RQ_Participation des travailleurs_30",
            "RS_Impôts sur le résultat_37",
