...
namespace SUMEDCO
{
    public partial class FormMessageHisto : Form
    {
        public FormMessageHisto()
        {
            InitializeComponent();
        }
        ...
        {
            cm.NouveauMessage(this, new FormMessage());
        }

        private void btnRepondre_Click(object sender, EventArgs e)
        {
            cm.Repondre(this, new FormMessage());
        }

        private void btnModifier_Click(object sender, EventArgs e)
        {
            cm.Modifier(this, new FormMessage());
        }
        ...
        private void dgvMessage_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvMessage.RowCount != 0)
            {
                cm.VoirMessage(this, new FormMessage());
            }
        }
