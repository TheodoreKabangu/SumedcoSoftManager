...
namespace SUMEDCO
{
    public partial class ConnexionAutorisation : Form
    {
        public ConnexionAutorisation()
        {
            InitializeComponent();
        }
        ...
        private void btnConnexion_Click(object sender, EventArgs e)
        {
            ...
            else if (cboAutorisation.Text != "")
            {
                if (etat == "autorisé")
                {
                    ...
                    MessageBox.Show("Accès refusé\nUne autorisation de l'administrateur est nécessaire", "Connexion", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
